...
CREATE TABLE "AGENTS" (
	...
	`HEATLOSSPERMIN`	INTEGER DEFAULT 0, PORTRAIT_INDEX INTEGER, BAGS number,
	FOREIGN KEY(`CITYID`) REFERENCES `CITIES`(`CITYID`)
);
INSERT INTO `AGENTS` VALUES (1,'Zulu',0,1,0,1,0,100,1,NULL,1,7,NULL);
INSERT INTO `AGENTS` VALUES (2,'NightHawk',0,1,0,1,0,100,1,NULL,1,19,NULL);
INSERT INTO `AGENTS` VALUES (3,'Foxhound',0,1,0,1,0,100,1,NULL,1,9,NULL);
